...
[![Version](https://img.shields.io/badge/version-2.18.6-2563EB.svg?style=flat-square)](VERSION)
...
**v2.18.6 更新：** `/dbs-standard-answer` 正式发布，用历史同构案例、失败案例与反例研究复杂困境中反复有效的解法及其边界。
...
完整的 29 个 Skill、适用时机、输入示例和常见衔接方式，见 [新手入门与 Skill 全目录](docs/新手入门.md#skill-全目录)。
